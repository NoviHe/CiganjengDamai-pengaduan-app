...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12"><a href="{{route('petugas.index')}}" class="btn btn-outline-purple btn-rounded btn-block z-depth-0 my-4 waves-effect"
            ...
            <div class="card-body px-lg-5">
                ...
                <div class="md-form">
                    <input type="text" name="id" id="materialSubscriptionFormPasswords" class="form-control"
                        value="{{$data ->id_petugas}}" disabled value="id">
                    <label for="materialSubscriptionFormPasswords">ID.</label>
                </div>
                <div class="md-form">
                    <input type="text" value="{{$data ->nama_petugas}}" disabled name="nama" id="materialSubscriptionFormEmail"
                        class="form-control">
                    <label for="materialSubscriptionFormEmail">Nama</label>
                </div>
                <div class="md-form">
                    <input type="text" value="{{$data ->level}}" disabled name="level" id="materialSubscriptionFormEmail"
                        class="form-control">
