    ...
    <div class="row" >
        <div class="col-md-12">
            ...
            <ol class="breadcrumb purple">
                ...
                <li class="breadcrumb-item text-light active">Data Tanggapan</li>
            </ol>
            </nav>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div
                ...
                <a href="" class="white-text mx-3">Table Laporan Tanggapan</a>
            ...
            <div class="px-4">
                ...
                <table id="datatable1" class="table table-hover mb-0">
                    ...
                    <tr>
                        ...
                        <th class="th-md">Nama Petugas</th>
                        <th class="th-md">Tanggal Tanggapan</th>
                    ...
                    <tr>
                        ...
                        <td>{{$dt ->getAdmin->nama_petugas}}</td>
                        <td>{{$dt ->tgl_tanggapan}}</td>
                        <td>{{$dt ->getData->getUser->nama}}</td>
                        @if ($dt ->getData->status == "selesai")
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                                <a class="dropdown-item" href="{{route('tanggapan.show',$dt->id_tanggapan)}}"><i
                                    class="fas fa-info mr-1"></i> Detail</a>
                                <a class="dropdown-item" href="{{route('pengaduan.show',$dt->id_pengaduan)}}"><i
                                    class="fas fa-eye mr-1"></i> Laporan</a>
                                <a href="#" class="dropdown-item hapus" link="tanggapan" hapus-id="{{$dt ->id_tanggapan}}"><i
