      ...
      <div class="row mb-3">
        ...
        <div class="col-md-12">
          ...
          <ul class="list-unstyled d-flex justify-content-center mb-0 py-4 list-inline">
            <li class="list-inline-item"><a href="https://web.facebook.com/herlambang.kun.3/" class="p-2 m-2 fa-lg fb-ic"><i class="fab fa-facebook-f white-text fa-lg">
                </i></a></li>
            ...
            <li class="list-inline-item"><a href="https://www.instagram.com/herlambang.saja/" class="p-2 m-2 fa-lg ins-ic"><i class="fab fa-instagram white-text fa-lg">
                </i></a></li>
